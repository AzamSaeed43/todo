...
class HomeController extends GetxController with GetTickerProviderStateMixin {
  ...
  final List<IconData> icons = [Icons.home, Icons.task_alt, Icons.person];

  final List<String> iconLabel = ["Home", "Tasks", "Person"];
  ...
  void moveToAddTask() {
    ...
    Future.delayed(
        const Duration(seconds: 1), () => Get.toNamed(Routes.ADD_TASK));
  }
